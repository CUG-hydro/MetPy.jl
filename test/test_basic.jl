...
@testset "test_speed_direction_roundtrip" begin
    ...
    wspd = numpy.array([15., 5., 2., 10.]) * units.meters / units.seconds
    wdir = numpy.array([160., 30., 225., 350.]) * units.degrees
...
@testset "test_heat_index_basic" begin
    ...
    assert_almost_equal(hi, values, 0)
end
...
@testset "test_heat_index_vs_nws" begin
    ...
    hi = heat_index(temp, rh)
    truth = units.Quantity(numpy.ma.array([87, 121, 40, 116], mask=[false, false, true, false]),
                           units.degF)
...
@testset "test_smooth_n_pt_5_units" begin
    ...
    shght = smooth_n_point(hght, 5, 1)
    s_true = numpy.array([[5640., 5640., 5640., 5640., 5640.],
                      [5684., 5675.75, 5666.375, 5658.875, 5651.],
                      [5728., 5711.5, 5692.75, 5677.75, 5662.],
                      [5772., 5747.25, 5719.125, 5696.625, 5673.],
                      [5816., 5784., 5744., 5716., 5684.]]) * units.meter
